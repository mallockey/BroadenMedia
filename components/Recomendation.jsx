        ...
        fellInWhichWay === 'balanced' ? '' :
          fellInWhichWay === 'left' ?
            Object.keys(recObj.needsMoreRepub).map(sourceInfo => {
              return (
                <a key={Math.random()} className="recs"href={recObj.needsMoreRepub[sourceInfo].siteUrl}>
              ...
              Object.keys(recObj.needsMoreDemo).map(sourceInfo => {
                return (
                  <a key={Math.random()} className="recs" href={recObj.needsMoreDemo[sourceInfo].siteUrl}>
